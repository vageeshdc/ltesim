...
static void Help (void)
{
	...
	std::cout <<
			...
			"\n"
			"\t ./LTE-Sim SingleCellWithFemto macro_cell_radius nbBuildings BuildingType activityRatio nbUE nbFemtoUE nbVoip nbVideo nbBE nbCBR sched_type frame_struct speed accessPolicy maxDelay videoBitRate seed(optional)"
			"\n\t\t --> ./LTE-Sim SingleCellWithFemto 1 2 0 1.0 1 1 0 0 1 0 1 1 3 0 0.1 128"
			"\n\n\n"
			"\n\t legend:"
